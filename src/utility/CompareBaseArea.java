...
/**
 * This class contains the compare method override that the Sort class methods call in order to compare base area values.
...
public class CompareBaseArea implements Comparator<Shape>{
	/**
	 * This method has two object parameters that then get compared via the getBaseArea method
